    ...
    Theme {
        ...
        styles: ThemeStyles {
            ...
            colors: ThemeColors {
                ...
                clean_background: bg,
                clean_surface_background: bg,
                clean_elevated_surface_background: elevated_surface,
                clean_border: hsla(228. / 360., 8. / 100., 25. / 100., 1.),
                clean_editor_background: editor,
                clean_terminal_background: bg,
                clean_selection: player.local().selection.alpha(0.25),
