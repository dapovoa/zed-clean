    ...
    Theme {
        ...
        styles: ThemeStyles {
            ...
            colors: ThemeColors {
                ...
                clean_chat_output_run_command_body: editor,
                clean_chat_output_run_command_text: hsla(221. / 360., 11. / 100., 86. / 100., 1.0),
                clean_chat_output_terminal_header: bg,
                clean_chat_output_terminal_body: editor,
                clean_chat_output_terminal_text: hsla(221. / 360., 11. / 100., 86. / 100., 1.0),
                clean_chat_output_edit_header: bg,
                clean_chat_output_edit_body: editor,
                clean_chat_output_code_header: bg,
                clean_chat_output_code_body: editor,
                clean_chat_output_thinking_header: bg,
                clean_chat_output_thinking_body: editor,
                clean_chat_output_indent_guide: hsla(228. / 360., 8. / 100., 25. / 100., 1.),
                clean_chat_output_scrollbar_thumb: hsla(228. / 360., 8. / 100., 30. / 100., 0.3),
                clean_chat_output_scrollbar_thumb_hover: hsla(228. / 360., 8. / 100., 30. / 100., 0.5),
                clean_chat_output_scrollbar_thumb_active: hsla(228. / 360., 8. / 100., 30. / 100., 0.7),
                clean_chat_output_background: bg,
                clean_git_input_height: 10.0,
