...
impl ThemeColors {
    ...
    pub fn light() -> Self {
        ...
        Self {
            ...
            clean_project_panel_edited_text: yellow().light().step_11(),
            clean_project_panel_active_background: neutral().light().step_3(),
    ...
    pub fn dark() -> Self {
        ...
        Self {
            ...
            clean_project_panel_edited_text: yellow().dark().step_11(),
            clean_project_panel_active_background: neutral().dark().step_3(),
            clean_chat_input_height: 10.0,
