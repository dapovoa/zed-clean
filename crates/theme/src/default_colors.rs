...
impl ThemeColors {
    ...
    pub fn light() -> Self {
        ...
        Self {
            ...
            agent_foreground: neutral().light().step_12(),
            agent_code_block_background: neutral().light().step_1(),
            agent_inline_code_background: neutral().light().step_12().alpha(0.08),
            agent_user_message_background: neutral().light().step_1(),
            agent_user_message_border: neutral().light().step_6(),
            agent_selection_background: blue().light().step_3().alpha(0.25),
            agent_code_block_border: neutral().light().step_6(),
            agent_user_message_foreground: neutral().light().step_12(),
            agent_user_message_selection_background: blue().light().step_3().alpha(0.25),
            clean_ui_background: neutral().light().step_1(),
            clean_ui_border: neutral().light().step_6(),
            clean_ui_scrollbar_thumb: neutral().light_alpha().step_3(),
            clean_ui_scrollbar_thumb_hover: neutral().light_alpha().step_4(),
            clean_project_panel_background: neutral().light().step_2(),
            clean_project_panel_hover_background: neutral().light_alpha().step_3(),
            clean_project_panel_text: neutral().light().step_12(),
            clean_project_panel_hover_text: blue().light().step_11(),
            clean_project_panel_active_text: blue().light().step_11(),
            clean_chat_input_height: 10.0,
            clean_chat_input_background: neutral().light().step_1(),
            clean_chat_input_text: neutral().light().step_12(),
            clean_chat_input_border: neutral().light().step_6(),
            clean_chat_output_text: neutral().light().step_12(),
                    clean_chat_output_selection: blue().light().step_3().alpha(0.25),
                    clean_chat_output_user_selection: blue().light().step_3().alpha(0.25),
                    clean_chat_output_user_bubble_bg: neutral().light().step_1(),
            
            clean_chat_output_user_bubble_text: neutral().light().step_12(),
            clean_chat_output_user_bubble_border: neutral().light().step_6(),
            clean_chat_output_run_command_header: neutral().light().step_2(),
            clean_chat_output_run_command_body: neutral().light().step_1(),
            clean_chat_output_run_command_text: neutral().light().step_12(),
            clean_chat_output_terminal_header: neutral().light().step_2(),
            clean_chat_output_terminal_body: neutral().light().step_1(),
            clean_chat_output_terminal_text: neutral().light().step_12(),
            clean_chat_output_edit_header: neutral().light().step_2(),
            clean_chat_output_edit_body: neutral().light().step_1(),
            clean_chat_output_code_header: neutral().light().step_2(),
            clean_chat_output_code_body: neutral().light().step_1(),
            clean_chat_output_thinking_header: neutral().light().step_2(),
            clean_chat_output_thinking_body: neutral().light().step_1(),
            clean_chat_output_indent_guide: neutral().light_alpha().step_5(),
            clean_chat_output_scrollbar_thumb: neutral().light_alpha().step_3(),
            clean_chat_output_scrollbar_thumb_hover: neutral().light_alpha().step_4(),
            clean_chat_output_scrollbar_thumb_active: neutral().light_alpha().step_5(),
            clean_chat_output_background: neutral().light().step_1(),
            clean_git_input_height: 10.0,
            clean_git_background: neutral().light().step_2(),
            clean_git_text: neutral().light().step_12(),
            clean_git_selection: blue().light().step_3().alpha(0.25),
            clean_editor_background: neutral().light().step_1(),
            clean_editor_selection: blue().light().step_3().alpha(0.25),
            clean_terminal_background: neutral().light().step_1(),
            clean_terminal_foreground: neutral().light().step_12(),
            clean_terminal_selection: blue().light().step_3().alpha(0.25),
    ...
    pub fn dark() -> Self {
        ...
        Self {
            ...
            vim_helix_normal_foreground: system.transparent,
            vim_helix_select_foreground: system.transparent,
            agent_foreground: neutral().dark().step_12(),
            agent_code_block_background: neutral().dark().step_1(),
            agent_inline_code_background: neutral().dark().step_12().alpha(0.08),
            agent_user_message_background: neutral().dark().step_1(),
            agent_user_message_border: neutral().dark().step_6(),
            agent_selection_background: blue().dark().step_3().alpha(0.25),
            agent_code_block_border: neutral().dark().step_6(),
            agent_user_message_foreground: neutral().dark().step_12(),
            agent_user_message_selection_background: blue().dark().step_3().alpha(0.25),
            clean_ui_background: neutral().dark().step_1(),
            clean_ui_border: neutral().dark().step_6(),
            clean_ui_scrollbar_thumb: neutral().dark_alpha().step_3(),
            clean_ui_scrollbar_thumb_hover: neutral().dark_alpha().step_4(),
            clean_project_panel_background: neutral().dark().step_2(),
            clean_project_panel_hover_background: neutral().dark_alpha().step_3(),
            clean_project_panel_text: neutral().dark().step_12(),
            clean_project_panel_hover_text: blue().dark().step_11(),
            clean_project_panel_active_text: blue().dark().step_11(),
            clean_chat_input_height: 10.0,
            clean_chat_input_background: neutral().dark().step_1(),
            clean_chat_input_text: neutral().dark().step_12(),
            clean_chat_input_border: neutral().dark().step_6(),
            clean_chat_output_text: neutral().dark().step_12(),
                    clean_chat_output_selection: blue().dark().step_3().alpha(0.25),
                    clean_chat_output_user_selection: blue().dark().step_3().alpha(0.25),
                    clean_chat_output_user_bubble_bg: neutral().dark().step_1(),
            
            clean_chat_output_user_bubble_text: neutral().dark().step_12(),
            clean_chat_output_user_bubble_border: neutral().dark().step_6(),
            clean_chat_output_run_command_header: neutral().dark().step_2(),
            clean_chat_output_run_command_body: neutral().dark().step_1(),
            clean_chat_output_run_command_text: neutral().dark().step_12(),
            clean_chat_output_terminal_header: neutral().dark().step_2(),
            clean_chat_output_terminal_body: neutral().dark().step_1(),
            clean_chat_output_terminal_text: neutral().dark().step_12(),
            clean_chat_output_edit_header: neutral().dark().step_2(),
            clean_chat_output_edit_body: neutral().dark().step_1(),
            clean_chat_output_code_header: neutral().dark().step_2(),
            clean_chat_output_code_body: neutral().dark().step_1(),
            clean_chat_output_thinking_header: neutral().dark().step_2(),
            clean_chat_output_thinking_body: neutral().dark().step_1(),
            clean_chat_output_indent_guide: neutral().dark_alpha().step_4(),
            clean_chat_output_scrollbar_thumb: neutral().dark_alpha().step_3(),
            clean_chat_output_scrollbar_thumb_hover: neutral().dark_alpha().step_4(),
            clean_chat_output_scrollbar_thumb_active: neutral().dark_alpha().step_5(),
            clean_chat_output_background: neutral().dark().step_1(),
            clean_git_input_height: 10.0,
            clean_git_background: neutral().dark().step_2(),
            clean_git_text: neutral().dark().step_12(),
            clean_git_selection: blue().dark().step_3().alpha(0.25),
            clean_editor_background: neutral().dark().step_1(),
            clean_editor_selection: blue().dark().step_3().alpha(0.25),
            clean_terminal_background: neutral().dark().step_1(),
            clean_terminal_foreground: neutral().dark().step_12(),
            clean_terminal_selection: blue().dark().step_3().alpha(0.25),
            agent_user_message_font_size: 0.75,
            agent_user_message_padding_y: 0.75,
            agent_user_message_padding_x: 0.5,
        }
