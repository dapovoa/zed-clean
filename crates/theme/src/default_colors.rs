...
impl ThemeColors {
    ...
    pub fn light() -> Self {
        ...
        Self {
            ...
            clean_background: neutral().light().step_1(),
            clean_surface_background: neutral().light().step_2(),
            clean_elevated_surface_background: neutral().light().step_2(),
            clean_border: neutral().light().step_6(),
            clean_editor_background: neutral().light().step_1(),
            clean_terminal_background: neutral().light().step_1(),
            clean_selection: blue().light().step_3().alpha(0.25),
    ...
    pub fn dark() -> Self {
        ...
        Self {
            ...
            clean_background: neutral().dark().step_1(),
            clean_surface_background: neutral().dark().step_2(),
            clean_elevated_surface_background: neutral().dark().step_2(),
            clean_border: neutral().dark().step_6(),
            clean_editor_background: neutral().dark().step_1(),
            clean_terminal_background: neutral().dark().step_1(),
            clean_selection: blue().dark().step_3().alpha(0.25),
